...
/**
 * @Description 验证码失败助手类，用于记录登录失败日志及跳转至失败页面
 * @author 38840472@qq.com
 * @date 2019-01-11 22:01:29
 */
@Component("WebCodeAuthenctiationFailureHandler")
public class WebCodeAuthenctiationFailureHandler implements AuthenticationFailureHandler {
	
	private final static String DEFAULT_TARGET_URL = "/login?error=true&code=false";
