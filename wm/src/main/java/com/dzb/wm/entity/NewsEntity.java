...
public class NewsEntity {
	...
	public boolean getTargetBlack() {
		return targetBlack;
	}

	public void setTargetBlack(boolean targetBlack) {
		this.targetBlack = targetBlack;
	}

	public boolean isSortUpdateTime() {
		return sortUpdateTime;
	}

	public void setSortUpdateTime(boolean sortUpdateTime) {
